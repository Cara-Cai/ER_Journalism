  ...
  return (
    ...
    {showCover ? (
      ...
      <div id="article_wrapper">
         {/* Lazy Loaded Slides */}
    {/* Lazy Loaded Slides */}
  <LazySlide title="Overview" viewportPosition={30/35}>
...
Since 2011, the Equipment Room (ER) has played a pivotal role in this innovation, equipping students with tools to realize their ideas. Thanks to Daniel Tsadok’s compilation of ER checkout records (2011–2024), we gain a unique window into ITP’s creative evolution.
  ...
  <LazySlide viewportPosition={100/35}>
  ...
  <FlourishEmbed viewportPosition={200/35} />

  <LazySlide title="2011: Foundations in DSLR Photography and Digital Media" viewportPosition={400/35}>
  ...
  <LazySlide viewportPosition={500/35}>
  ...
  <LazySlide title="2012: The Shift to Portability" viewportPosition={850/35}>
  ...
  <LazySlide viewportPosition={1000/35}>
  ...
  <LazySlide title="2015: Enter Virtual Reality and Physical Computing" viewportPosition={1500/35}>
  ...
  <LazySlide viewportPosition={1700/35}>
  ...
  <LazySlide title="2017: The Golden Age of Equipment Demand" viewportPosition={2100/35}>
  ...
  <LazySlide viewportPosition={2200/35}>
  ...
  <LazySlide title="2020: Adapting to Remote Creation" viewportPosition={2400/35}>
  ...
  <LazySlide viewportPosition={2500/35}>
  ...
  <LazySlide title="2023-2024: A New Era in Physical Computing" viewportPosition={2800/35}>
  ...
  <LazySlide viewportPosition={3000/35}>
  ...
  <LazySlide title="Looking Ahead: Predicting Future Needs Through Past Trends" viewportPosition={3400/35-4}>
  ...
  <LazySlide viewportPosition={3500/35-4}>
